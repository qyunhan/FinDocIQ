...
Output -> out/step1_toc.json   (document, provenance, parts, sections[])

Usage:
  python build_toc.py "DBS_4Q25_Pillar3.pdf"
  python build_toc.py "OCBC_4Q25_Pillar 3.pdf" --out out/ocbc_toc.json
"""

...
API_LOG_XLSX = "outputs/API_Log.xlsx"   # path relative to DELIVERABLE/
...
def main():
    ...
    if args.toc:
        TOC_PATH = args.toc
    elif os.path.exists(f"outputs/{bank_slug}_toc.json"):
        TOC_PATH = f"outputs/{bank_slug}_toc.json"
    # else keep default out/step1_toc.json

    out_path = args.out or f"outputs/{bank_slug}.xlsx"
